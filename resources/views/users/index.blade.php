 ...
 <section >
    <div class="card card-info">
      <div class="card-header">
        <h1 class="card-title pull-right">Usuarios</h1>
        <button class="btn btn-primary btn-xs pull-left open_modal" model="users/" title="nuevo registro" action="create">Nuevo</button>
