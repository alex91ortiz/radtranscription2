    ...
    <section >
        ...
        <div class="card card-info">
          <div class="card-header">
            <h1 class="card-title pull-right">Tipo Examen</h1>
            <button class="btn btn-primary btn-xs pull-left open_modal" model="typeexam/" title="nuevo registro" action="create">Nuevo</button>
            <div class="clearfix"></div>
          </div>
          <!-- /.card-header -->
          <div class="card-body master_list">
                @include('typeexam.list',["typeexam"=>$typeexam])
          </div>
        </div>
