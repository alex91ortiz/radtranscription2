    ...
    <section >
        ...
        <div class="card card-info">
          <div class="card-header">
            <h1 class="card-title pull-right">Especialista</h1>
            <button class="btn btn-primary btn-xs pull-left open_modal" model="specialist/" title="nuevo registro" action="create">Nuevo</button>
            <div class="clearfix"></div>
          </div>
          <!-- /.card-header -->
          <div class="card-body master_list">
                @include('specialist.list',["specialist"=>$specialist])
          </div>
        </div>
