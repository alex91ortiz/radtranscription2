    ...
    <section >
        <div class="card card-info">
          <div class="card-header">
            <h1 class="card-title pull-right">Compañia</h1>
            <button class="btn btn-primary btn-xs pull-left open_modal" model="companie/" title="nuevo registro" action="create">Nuevo</button>
            <div class="clearfix"></div>
          </div>
          <!-- /.card-header -->
          <div class="card-body master_list">
                @include('companie.list',["companie"=>$companie])
          </div>
        </div>
